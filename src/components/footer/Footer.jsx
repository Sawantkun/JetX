...
export default function Footer() {
    ...
    const { mode } = context
    return (
        <footer className="footer-bg absolute bottom-0 left-0 w-full text-secondary body-font bg-gray300 " style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className='h-[80px] w-full  bg-primarylight flex items-center justify-evenly z-10'>
              <h1 className='text-secondary text-xl'>Get the inside scoop on new products, designs, promotions, and more.</h1>
              <div className='flex'>
              <Input className='mx-8' placeholder="Email Address" />
              <button className="bg-yellow text-secondary py-2 px-5 rounded">Sign Up</button>
              </div>
          </div>
            <div className="container px-20 py-24 mx-auto " >
                <div className="flex flex-wrap md:text-left text-center order-first  pl-10 footerbc">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4 z-10">
